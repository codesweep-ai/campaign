...
LDFLAGS    := -s -w -X github.com/codesweep-ai/campaign/internal/cli.version=$(VERSION)
VIEWERLDFLAGS := -s -w -X github.com/codesweep-ai/campaign/dispatch-viewer/internal/cli.version=$(VERSION)
